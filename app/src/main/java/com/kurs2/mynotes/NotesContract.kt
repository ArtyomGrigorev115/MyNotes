    ...
    companion object{
        final class NotesEntry : BaseColumns{
            ...
            companion object{
                ...
                public val CREATE_COMMAND: String = "CREATE TABLE IF NOT EXISTS $TABLE_NAME ($_ID $TYPE_INTEGER PRIMARY KEY AUTOINCREMENT, $COLUMN_TITLE $TYPE_TEXT, $COLUMN_DESCRIPTION $TYPE_TEXT, $COLUMN_DAY_OF_WEEK $TYPE_TEXT, $COLUMN_PRIORITY $TYPE_INTEGER)"
